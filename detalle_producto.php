        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li>
                        <a href="admin/subirAdmin.php">Subir Diseño</a>
                    </li>
                    <li>
                        <a href="#">Pedidos</a>
                    </li>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-sm-12 col-md-6 cont_img">
                        <div>
                            <img src="images/<?php echo $rowProducto['imagen'] ?>" class="img-fluid" alt="Product Image">
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        ...
                        <hr>
                        <h2 class="mt-3">Talla: <small><?php echo $rowProducto['talla'] ?></small></h2>
                        <div class="bg-gray py-2 mt-4">
                            <h2 class="mb-0">
                                Precio:
                            </h2>
                            <h4 class="mt-0">
                                <small>$ <?php echo $rowProducto['precio'] ?></small>
                            </h4>
                        </div>
                        <div class="mt-4">
